...
void WindowView::createInstance() {
...
bool WindowView::checkValidationLayerSupport() {
	uint32_t layerCount;
...
std::vector<const char*> WindowView::getRequiredExtensions() {
...
VkResult WindowView::CreateDebugReportCallbackExt(
	VkInstance instance,
...
void WindowView::DestroyDebugReportCallbackEXT(VkInstance instance,
...
void WindowView::setupDebugCallback() {
...
VKAPI_ATTR VkBool32 VKAPI_CALL WindowView::debugCallback(
...
void WindowView::pickPhysicalDevice() {
...
int WindowView::rateDeviceSuitability(VkPhysicalDevice device) {
...
bool WindowView::checkDeviceExtensionsSupport(VkPhysicalDevice device) {
...
void WindowView::createLogicalDevice() {
...
VkSurfaceFormatKHR WindowView::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR WindowView::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentationModes) {
...
VkExtent2D WindowView::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
void WindowView::createSwapChain() {
...
void WindowView::createImageViews() {
